...
👉 もし GitHub の README.md に載せたい場合は、上の説明文を「⚠️注意事項」という見出し付きで書くのが良いと思います。

質問ですが、この説明文は 「README.md（公開用）」に載せたい ですか？
それとも 「自分の研究ノート用」 にシンプルにまとめたいですか？
